...
const char *endpoint_u2f_register = "http://【FIDOエミュレータサーバ】/device/u2f_register";
const char *endpoint_u2f_authenticate = "http://【FIDOエミュレータサーバ】/device/u2f_authenticate";
const char *endpoint_u2f_version = "http://【FIDOエミュレータサーバ】/device/u2f_version";
...
#define DEVICE_NAME   "ESP32 Dev Module"
...
//  pSecurity->setCapability(ESP_IO_CAP_IN);
  ...
  pAdvertising->addServiceUUID(SERVICE_UUID_fido);
  pAdvertising->start();
